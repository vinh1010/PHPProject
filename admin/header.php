  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="../index.php" class="logo">
        ...
        <span class="logo-lg"><img src="../customer/images/logo.png" width="80%" alt=""></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="./assets/dist/user-image.png" class="user-image"
                  alt="User Image">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  <img src="./assets/dist/user-image.png" class="img-circle"
                    alt="User Image">
